...
category: API2
compat:
  - category: api2/Event/notificationRemoved
    feature: *
---
...
<Section>
  ...
  [`Bot.addListener()`](/api2/Bot/addListener)를 이용해 이벤트에 대한 리스너를 추가할 수 있습니다.
  [`Event.NOTIFICATION_REMOVED`](/api2/Event/NOTIFICATION_REMOVED)를 이용해 이벤트 이름을 전달할 수도 있습니다.
  ~~~js
