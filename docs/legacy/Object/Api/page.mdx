  ...
  <Table>
    ...
    <Tbody>
      ...
      <Tr>
        <Td><span>`String`</span></Td>
        <Td>
          <Feature status={["api2/Object/Api", "papagoTranslate"]}>[`papagoTranslate`](/legacy/Api/papagoTranslate)`(sourceLanguage: String, targetLanguage: String, content: String, errorToString?: Boolean = false)`</Feature> \
