    ...
    <Tbody>
      ...
      <Tr>
        ...
        <Td>
          ...
          [`Api.interruptThreads()`](/legacy/Api/interruptThreads) 실행 이후 스크립트의 모든 쓰레드의 `interrupt` 처리가 완료되었는지의 여부를
          반환합니다.
        </Td>
      </Tr>
      <Tr>
      ...
      <Tr>
        <Td><span>`String`</span></Td>
        <Td>
          <Feature category={"api2/Object/Api"} feature={"papagoTranslate"}>[`papagoTranslate`](/legacy/Api/papagoTranslate)`(sourceLanguage: String, targetLanguage: String, content: String, errorToString?: Boolean = false)`</Feature> \
      ...
      <Tr>
        <Td><span>`Boolean`</span></Td>
        <Td>
          [`replyToID`](/legacy/Api/replyToID(BigInt,String,Boolean$))`(roomId: BigInt, message: String, hideToast?:
          Boolean = false)` \
      ...
      <Tr>
        <Td><span>`Boolean`</span></Td>
        <Td>
          [`replyToID`](/legacy/Api/replyToID(String,String,Boolean$))`(roomId: String, message: String, hideToast?:
          Boolean = false)` \
          특정 ID로 식별되는 방에 메시지를 발신하고 방에 대한 세션의 존재 여부를 반환합니다. `hideToast`가 `true`일 경우 방의 세션 존재 여부를 토스트 메시지로 출력합니다.
        </Td>
      </Tr>
      ...
      <Tr>
        <Td><span>`void`</span></Td>
        <Td>
          [`UIThread`](/legacy/Api/UIThread)`(func: () => Any?, onComplete?: (error: java.lang.Throwable?, result: Any?)
          => Any?)` \
