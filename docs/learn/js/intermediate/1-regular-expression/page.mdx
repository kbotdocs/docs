...
<Section>
  ...
  <Section>
    ...
    <Table>
      <Thead>
        <Tr>
          <Th colSpan={2}>정규 표현식의 그룹/역참조</Th>
        </Tr>
      </Thead>
      <Tbody>
        <Tr>
...
<Section>
  ...
  <Table>
    ...
    <Tbody>
      <Tr>
        <Td><span>`d`<sup>메신저봇R 0.7.40-alpha.03 이상</sup></span></Td>
        <Td>
      ...
      <Tr>
        <Td><span>`u`<sup>메신저봇R 0.7.40-alpha.03 이상</sup></span></Td>
        <Td>
