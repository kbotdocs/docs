...
category: 기초 자습서
milestone:
  prev: basic/11-function
  next: basic/conclusion
---
...
<Section>
  ...
  cat.name = "Cheese";
  cat["sexual"] = "male";
  cat.jump = (height) => `Jump ${height * 100}m!`;
  ~~~
</Section>
<Section>
  ## this: 객체 자신을 참조하기
...
<Section>
  ...
  더 직접적인 예를 들어보겠습니다. 이전에 [배열 편](/basic/8-array)에서 배열이 가지는 요소의 개수를 구하기 위해 `length`를 배웠습니다.
