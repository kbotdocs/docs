  ...
  <Table>
    ...
    <Tbody>
      ...
      <Tr>
        <Td><span><RequestMethod method={"GET"}/></span></Td>
        <Td>
          [`/dashboard`](/reference/iris/Endpoint/dashboard) \
          Iris의 구성을 위한 웹 UI입니다.
        </Td>
      </Tr>
    </Tbody>
  </Table>
...
<Section>
  ...
  Iris를 이용한 개발을 용이하게 하는 프레임워크입니다. 사용을 희망하는 프로그래밍 언어와 각 프레임워크의 특징에 따라 선택할 수 있습니다.

  <Table>
    <Thead>
      <Tr>
        <Th colSpan={2}>Iris를 위한 프레임워크</Th>
      </Tr>
    </Thead>
    <Tbody>
      <Tr>
        <Td><span>irispy-client</span></Td>
        <Td>
          [`/config`](/reference/iris/Framework/irispy-client) \
          Iris를 위한 Python 프레임워크입니다.
        </Td>
      </Tr>
    </Tbody>
  </Table>
