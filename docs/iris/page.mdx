  ...
  <Table>
    ...
    <Tbody>
      ...
      <Tr>
        <Td><span><RequestMethod method={"POST"}/></span></Td>
        <Td>
          [`/config/botport`](/iris/Endpoint/config/botport) \
      ...
      <Tr>
        <Td><span><RequestMethod method={"POST"}/></span></Td>
        <Td>
          [`/config/dbrate`](/iris/Endpoint/config/dbrate) \
      ...
      <Tr>
        <Td><span><RequestMethod method={"POST"}/></span></Td>
        <Td>
          [`/config/endpoint`](/iris/Endpoint/config/endpoint) \
      ...
      <Tr>
        <Td><span><RequestMethod method={"POST"}/></span></Td>
        <Td>
          [`/config/sendrate`](/iris/Endpoint/config/sendrate) \
          메시지 전송 속도를 업데이트합니다.
        </Td>
      </Tr>
    </Tbody>
